...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/multisheller-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10963&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/multisheller-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `multisheller` can be installed with:

```
conda install multisheller
```

It is possible to list all of the versions of `multisheller` available on your platform with:
